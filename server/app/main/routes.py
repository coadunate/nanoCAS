...
MICAS_DIR = os.path.join(os.path.expanduser('~'), '.micas')
...
def get_uid():
    ...
    cache_path = get_micas_cache_path()
    ...
    uid_dir = os.path.join(MICAS_DIR, uid)
...
def get_coverage():
    ...
    alert_cfg_file = os.path.join(MICAS_DIR, project_id, 'alertinfo.cfg')
    try:
